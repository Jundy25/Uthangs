...
<body>
    ...
    <div class="heading">
        <h1>About Us</h1>
        <p>'Lost, jubled, and unknow debt list, our website is here to help about this problem'</p>
    </div>
    <div class="container">
        <section class="about">
            <div>
            ...
            <div class="about-content">
                <p>Having a list that will record, update and edit customer status
                    ...
                    customer records and help navigate in many records of list of
                    each of their customer. This website is craeted for this purpose
