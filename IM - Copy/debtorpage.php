...
<div id="edituser" class="modal" style="display: none;">
            ...
            <form autocomplete="off" name="form1" id="form1" class="modal-content animate" action="edituser.php"
              method="post">

              <div class="imgcontainer">
                <span onclick="document.getElementById('edituser').style.display='none'; clearInput()" class="close"
              ...
              <div class="container">
                ...
                <input id="id1" type="text" placeholder="Enter Username" name="bname"
                  onkeypress="return AvoidSpace(event)" value="<?php echo $_REQUEST["bname"]; ?>" required>
                ...
                <input id="id2" class="num" type="tel" placeholder="Enter Phone#" name="phone"
                  onkeypress="return onlyNumberKey(event)" value="<?php echo $_REQUEST["phone"]; ?>" required>
    ...
    <form autocomplete="off" name="form1" id="form1" class="modal-content animate" action="insertutang.php"
      ...
      <div class="imgcontainer">
        <span onclick="document.getElementById('id01').style.display='none'; clearInput()" class="close"
          title="Close Modal">&times;</span>
        <label class="label-text" for="input-name">Add Uthang to <input name="bname"
      ...
      <div class="container">
        ...
        <input id="id2" class="num" onfocus="this.value=''" type="tel" placeholder="Enter Quantity" name="quantity"
  ...
  <div class="customer-box-preview-container">
    <div style="display:flex; flex-direction: column;">
      <div class="customer-box-preview-left-side-container">
        ...
        <div>
          <p>Name:<input name="bname" value="<?php echo $_REQUEST["bname"]; ?>" size="7"
  ...
  <div class="customer-box-preview-right-side-container">
    <div class="record-btn-container">
      ...
      <div class="customer-box-review-btn-container">
        ...
        <button class="customer-box-review-btn" onclick="document.getElementById('id01').style.display='block'">Edit
          Record</button>
        <Form autocomplete="off" name="form1" id="form2" action="payall.php" method="post">
          <input type="hidden" name="bname" value="<?php echo $_REQUEST["bname"]; ?>" size="4"
            style="background: transparent; border: none;" readonly></input>
    ...
    <div class="customer-box-preview-table">
      <table>
        ...
        $ddate = date("Y/m/d");
        $name = $_REQUEST["bname"];
        $sql = "SELECT id, item_name, quantity, price, quantity*price AS total, date_format((added_on), '%m/%d/%y') AS date FROM utangs JOIN items ON utangs.item_id=items.item_id WHERE debtor = '$name';";
